	...
	public static void main(String[] args) {
	  ...
	  @Bean
		CommandLineRunner start(ClientRepository customerrepository, RepositoryRestConfiguration restconfg) {
			...
			return args ->{
				customerrepository.save(new Client(null,"hajar", "hajar@gmail.com")); 
				customerrepository.save(new Client(null,"test1", "test1@gmail.com")); 
				customerrepository.save(new Client(null,"test2", "test1@gmail.com")); 
